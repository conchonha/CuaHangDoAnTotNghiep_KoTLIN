...
class Fragment_Thietbiluutruphukien : Fragment() {
    private var view1: View? = null
    private var recyclerView: RecyclerView? = null
    private var txtxemthem1: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_thietbiluutruphukien, container, false)
        anhxa()
        dataThietbiluutruphukien
        return view1
    }
    ...
    //        });
    //    }
    private val dataThietbiluutruphukien: Unit
        private get() {
            val dataService = APIServices.getService()
            val callback = dataService.getdataThietbiluutruphukien()
            callback.enqueue(object : Callback<List<GetdataSanphammoinhat>> {
                override fun onResponse(
                    ...
                    Log.d("AAA", "thietbiluutruphukien$response")
                    if (response.isSuccessful) {
                        ...
                        txtxemthem1!!.setOnClickListener {
    ...
    private fun anhxa() {
        txtxemthem1 = view1!!.findViewById(R.id.txtxemthem1)
        recyclerView = view1!!.findViewById(R.id.recyclerviewthietbiluutruphukien)
