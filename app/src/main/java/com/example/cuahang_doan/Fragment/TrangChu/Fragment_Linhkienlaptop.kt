...
class Fragment_Linhkienlaptop : Fragment() {
    private var view1: View? = null
    private var recyclerView: RecyclerView? = null
    private var txtxemthem: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_linhkienlaptop, container, false)
        anhxa()
        getdataLinhkienlaptop()
        return view1
    }

    private fun getdataLinhkienlaptop() {
        val dataService = APIServices.getService()
        val callback = dataService.dataLinhkienlaptop
        callback.enqueue(object : Callback<List<GetdataSanphammoinhat>> {
            override fun onResponse(
                ...
                Log.d("AAA", "linhkienlaptop$response")
    ...
    private fun anhxa() {
        txtxemthem = view1!!.findViewById(R.id.txtxemthem)
        recyclerView = view1!!.findViewById(R.id.recyclerviewlinhkienlaptop)
