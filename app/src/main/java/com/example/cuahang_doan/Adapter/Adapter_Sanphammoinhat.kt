...
import com.example.cuahang_doan.Adapter.Adapter_Sanphammoinhat.Viewholdler
...
class Adapter_Sanphammoinhat(
    ...
    inner class Viewholdler(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val roundedImageView: RoundedImageView
        val txtsale: TextView
        val txtgiasp: TextView
        val txttensanpham: TextView
        val txtgiaspsaukhuyenmai: TextView
